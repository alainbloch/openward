...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Cut','Copy','Paste','PasteWord','Undo','Redo','-', 'Subscript','Superscript','-','OrderedList','UnorderedList','-','Print'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Outdent','Indent','-','Link','Unlink']
] ;

FCKConfig.ToolbarSets["Media"] = [
	['Source','Cut','Copy','Paste','PasteWord','Undo','Redo','-', 'Subscript','Superscript','-','OrderedList','UnorderedList','-','Bold','Italic','Underline','StrikeThrough','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Outdent','Indent','-','Link','Unlink','-','Print']
] ;